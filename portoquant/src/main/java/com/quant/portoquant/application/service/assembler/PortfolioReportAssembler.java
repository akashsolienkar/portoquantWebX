...
public class PortfolioReportAssembler {
    ...
    public PortfolioReportData toReportData(User user, Portfolio portfolio, List<Asset> assets,SimulationResult simulation) {
      
    	List<AssetSummary> assetSummaries= buildAssetSummaries(assets);
    	...
    	return PortfolioReportData.builder()
                ...
                .pieChartData(new AssetDistributionChart(assetSummaries))
                .build();
    }
    ...
    private List<AssetSummary> buildAssetSummaries(List<Asset> assets) {
        return assets.stream()
                .map(asset -> AssetSummary.builder()
                        ...
                        .weight(asset.getAllocation().doubleValue())
